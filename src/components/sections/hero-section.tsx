    ...
    <div className="relative w-full min-h-[1100px]">
      ...
      <section className="sm:px-6 lg:px-8 md:py-24 w-full max-w-7xl mx-auto pt-16 px-4 pb-20 relative" style={{ zIndex: 1 }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 w-full mt-20 scroll-fade scroll-fade-delay-3">
          <Link href="/solutions/strategy-insights" className="group relative border border-[#27272a] rounded-xl p-7 bg-[#111113] hover:border-[#3f3f46] card-hover flex flex-col h-full">
          ...
          <Link href="/memberships" className="group relative border border-[#27272a] rounded-xl p-7 bg-[#111113] hover:border-[#3f3f46] card-hover flex flex-col h-full">
            <div className="w-10 h-10 bg-[#1a1a1d] border border-[#27272a] rounded-lg flex items-center justify-center mb-5">
          ...
          <Link href="/consulting" className="group relative border border-[#27272a] rounded-xl p-7 bg-[#111113] hover:border-[#3f3f46] card-hover flex flex-col h-full">
            <div className="w-10 h-10 bg-[#1a1a1d] border border-[#27272a] rounded-lg flex items-center justify-center mb-5">
              <svg className="w-5 h-5 text-[#c9a227]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
